...
namespace Strings
{
    public static class UsingRanges
    {
        ...
        {
            regionCode = new string(productionCode[0], 1);
            locationCode = new string(productionCode[3..5]);
            dateCode = new string(productionCode[7..10]);
            factoryCode = new string(productionCode[^4..]);
        }
        ...
        {
            countryCode = new string(serialNumber[^9], 1);
            manufacturerCode = new string(serialNumber[^8..^6]);
            factoryCode = new string(serialNumber[^5..^1]);
            stationCode = new string(serialNumber[^1], 1);
        }
    }
}
